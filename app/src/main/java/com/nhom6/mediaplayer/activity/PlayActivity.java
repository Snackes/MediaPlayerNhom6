...
public class PlayActivity extends AppCompatActivity implements SongPlayingFragment.OnFragmentInteractionListener, ListPlayingSongFragment.OnFragmentInteractionListener {
    ...
    //for play bar
    public ImageButton btnplay_playbar;
    public ImageButton btnnext_playbar;
    public ImageButton btnprev_playbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentPlaying.putInt("seekBar", song.getDuration());
        fragmentPlaying.putString("totalTime",timeFormat.format(song.getDuration()));
        fragmentPlaying.putString("playingTime", timeFormat.format(serviceClass.getCurrentPositionSong()));
